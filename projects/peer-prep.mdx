...
<img src="https://choonsiongng.s3.ap-southeast-2.amazonaws.com/images/peer-prep/peer-prep_user_service_architecture_diagram.jpg" style="min-width: min(250px, 100%); width: 28%;" />
...
<style>
    ...
    .grid-item {
        flex: 1;
        min-width: min(400px, 100%); /* Minimum width of each item before wrapping */
